...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument("--username", help="Username to use for login (default: astrodata)", default="astrodata")
        ...
        parser.add_argument("--no-error", default=False, action="store_true", help="Should not throw command error when set")
